...
export default function MyOrders() {
  ...
  const { data: myorders, error } = useSWR(
    `${process.env.REACT_APP_API_HOST}/onOrders`,
    fetchOrders
  );
                  ...
                  <div key={idx} className="my-3 p-4 bg-base-100 rounded-lg">
                    <div className="flex justify-between">
                      ...
                      <div className="flex flex-col items-end">
                        ...
                        <div className="flex">
                          <div className="badge badge-info badge-outline badge-sm mt-2">
                            {data?.pay_method}
                          </div>
                          <div className="badge badge-info badge-outline badge-sm ml-1 mt-2">
                    ...
                    <div className="flex">
                      ...
                      <div className="grow flex flex-col ml-4 text-xs">
                        ...
                        <div className="opacity-70">
                          ...
                          } x Rp${new Intl.NumberFormat(["ban", "id"]).format(
                            data?.Products[0]?.On_orders_detail
                              ?.sum_price_each /
                              data?.Products[0]?.On_orders_detail?.qty
                          )}`}
                        </div>
                    ...
                    <div className="flex justify-between mt-2 items-center">
                      <div className="font-bold text-lg">{`Rp${new Intl.NumberFormat(
                        ["ban", "id"]
