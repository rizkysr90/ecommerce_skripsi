          ...
          <div className="mx-3 md:mx-20">
            ...
            <div className="bg-base-100 md:bg-transparent p-3 md:p-0 flex flex-col md:flex-row mt-2">
              ...
              <div className="grow flex flex-col mt-3 md:mt-0 md:mr-8">
                ...
                <div className="text-lg mt-2 font-bold text-secondary">
                  Rp
                ...
                <div className="flex justify-between ">
                  <div className="flex flex-col text-sm">
                    ...
                    <div className="opacity-70 mt-2">
                      No.SKU : {product?.sku ? product?.sku : "-"}
                    </div>
                  </div>
                  <div>
                    <div className="flex">
                      <div className="flex flex-col text-sm mr-3">
                        ...
                        <span className="font-bold mt-2">
                          {product?.shipping_weight / 1000} Kg
                        </span>
                      </div>
                      <div className="flex flex-col text-sm mr-3">
                        <span className="opacity-70">Berat Produk</span>
                        <span className="font-bold mt-2">
                          {product?.product_weight / 1000} Kg
                        </span>
                      </div>
                      <div className="flex flex-col text-sm">
                ...
                <div className="mt-4 text-sm">
                  ...
                  <div className="mt-2 opacity-70">{product?.description}</div>
                </div>
              </div>
              ...
              <div className="w-full  md:basis-3/12 flex flex-col h-min rounded-lg">
                ...
                <div className="flex text-sm justify-between mt-2">
                  ...
                  <div className="font-bold">
                    Rp
                    {new Intl.NumberFormat(["ban", "id"]).format(
                      product?.sell_price * trackQty
                    )}
                  </div>
                </div>
                <div
                  className={`btn  normal-case mt-4 text-base-100 ${
                    isLoadingToCart ? "btn-disabled" : ""
                  } ${product?.stock < 1 ? "btn-disabled" : "btn-secondary"}`}
                  onClick={addToCart}
                >
                ...
                {user ? (
                  <div
                    className={`btn ${
                      product?.stock > 1 ? "btn-success" : "btn-disabled"
                    } text-white normal-case mt-2`}
                    onClick={() => {
                  ...
                  <Link
                    className="btn btn-secondary btn-outline text-black normal-case mt-2"
                    to={"/auth/login"}
                  >
                    Beli Langsung
                  </Link>
