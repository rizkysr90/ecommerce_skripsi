...
export default function ShippingAddressNew() {
    ...
    const getProvince = async () => {
      try {
        const res = await axios.get(
          `${process.env.REACT_APP_API_HOST}/regions/getProvince`
        );
  ...
  const handleSubmit = async (e) => {
    try {
      ...
      await axios.post(
        `${process.env.REACT_APP_API_HOST}/customers/newAddress`,
        formJSON
      );
      setIsLoading(false);
      if (products) {
      ...
      <div className="pt-20 mx-3 md:mx-14">
        <form className="" onSubmit={handleSubmit}>
              ...
              <div className="flex flex-col">
                ...
                <div className="flex">
                  ...
                  <div className="form-control grow ml-2">
                    ...
                    >
                      ...
                      {statusGetState === "loading" ? (
                        <option disabled>Sedang dimuat</option>
                      ) : (
                ...
                <div className="modal">
                  <div className="modal-box relative">
                    ...
                    <p className="py-4">
                      Akses lokasi digunakan untuk pengiriman dengan metode{" "}
          ...
          {location.coordinates?.lat && location.coordinates?.lng ? (
            ...
            <div className="flex justify-end mb-10">
              <button
                className="btn btn-disabled normal-case w-full md:w-auto"
                type="submit"
                disabled
              >
                Simpan Alamat
