  ...
  const handleSubmitOrder = async (e) => {
    try {
      ...
      if (formJSON.shipping_method === "delivery_order" && deliveryOrder) {
        ...
        formJSON.shipping_address = `${selectedAddress?.recipient_name}^${selectedAddress?.recipient_phone_number}^${selectedAddress.street}^${selectedAddress.village}^${selectedAddress.district}^${selectedAddress.state}^${selectedAddress.province}^${selectedAddress.postal_code}`;
      }
      ...
      const res = await axios
        .post(`${process.env.REACT_APP_API_HOST}/onOrders`, formJSON)
        .then((res) => res.data);
      setIsLoading(false);
            ...
            <div className="">
              ...
              >
                <div className="basis-8/12">
                  ...
                  {deliveryOrder && (
                    <div className="mt-3 ">
                      <div className="flex flex-col bg-base-100 border-primary border p-3 w-full rounded mb-3">
                        <div className="text-sm font-bold">Dikirim dari :</div>
                        <div className="divider my-0"></div>
                        <div className="text-sm">Rizki Plastik</div>
                        <div className="text-xs opacity-70">
                          Jl. Puri Cendana No.112, Sumberjaya, Kec. Tambun Sel.,
                  ...
                  <div className="bg-base-100 rounded p-3 mt-3">
                    ...
                    <div className="form-control">
                      <label className="label cursor-pointer" htmlFor="cod">
                  ...
                  <div>
                    <div className="flex flex-col">
                      ...
                      <span className="text-sm">
                        {`Contoh : 081283007959 / 6281283007959`}
                      </span>
                    </div>
                    <div className="divider my-1"></div>
                    <div className="form-control">
                  ...
                  <div className="bg-base-100 p-3 mt-3 rounded">
                    ...
                    {products?.map((data, idx) => {
                      ...
                      orderSummary.totalPrice +=
                        data?.sell_price * data?.Cart_detail?.qty;
                      return (
                        <div key={idx}>
