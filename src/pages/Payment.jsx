...
function Payment() {
    ...
    const handlePayment = async (e) => {
        ...
        try {
            setIsLoading(true);
            const res = await axios.put(`${process.env.REACT_APP_API_HOST}/onOrders/payment`,formJSON,
            {
                headers: {
                ...
                <div className='flex flex-col bg-base-100 rounded-lg p-3 items-center'>
                    ...
                    </div>
                    {
                     ...
                     <form 
                        ...
                        {
                            previewImg ? 
                            <button type='submit' className='btn btn-success normal-case text-base-100 w-full mb-3'
